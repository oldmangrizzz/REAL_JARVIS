---
name: self-improve-harness
description: "Self-improvement loop for agent skills and docs with Claude-powered proposer, scorer, approval queue, rollback, and audit logs."
---
