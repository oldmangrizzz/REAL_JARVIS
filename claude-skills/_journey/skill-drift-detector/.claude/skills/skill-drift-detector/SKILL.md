...
description: "Nightly cron that audits Claude Code skills for drift: missing triggers, overlapping descriptions, oversized files, and broken progressive disclosure."
---
